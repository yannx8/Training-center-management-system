  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="page-subtitle">Department announcements targeted to trainers</p>
      </div>
      ...
      {announcements.length === 0 && (
        <div className="card p-12 text-center">
          ...
          <p className="text-sm text-gray-400 mt-1">Announcements from your HOD will appear here.</p>
        </div>
      )}
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 flex-wrap mb-1">
                  ...
                  {a.department?.name && (
                    <span className="badge-blue">{a.department.name}</span>
                  )}
                </div>
