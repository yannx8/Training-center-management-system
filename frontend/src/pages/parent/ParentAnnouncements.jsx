// FILE: src/pages/parent/ParentAnnouncements.jsx
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="page-subtitle">Messages from your children's departments</p>
      </div>
      ...
      {announcements.length === 0 && (
        <div className="card p-12 text-center">
          ...
          <p className="text-sm text-gray-400 mt-1">Department announcements for parents will appear here.</p>
        </div>
      )}
        ...
        {announcements.map(a => (
          <div key={a.id} className="card p-5">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-pink-100 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5">
