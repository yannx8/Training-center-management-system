...
export default function StudentLayout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50 theme-student">
      <Sidebar navItems={NAV} roleLabel={t('roles.student', 'Student')} roleColor="bg-primary-600" />
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        <TopBar roleLabel={t('roles.student', 'Student')} roleColor="bg-primary-600" />
