...
import { LayoutDashboard, Users, Building2, BookMarked, Award, DoorOpen, CalendarDays, MessageSquare } from 'lucide-react';
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <TopBar roleLabel="Administrator" roleColor="bg-violet-600" />
