...
export const adminApi = {
  ...
  getProgramTree:  (id)    => api.get(`/admin/programs/${id}/tree`).then(r=>r.data),
...
export const hodApi = {
  ...
  getTrainerAvailabilityStatus:(weekId) => api.get("/hod/availability/status",{params:{weekId}}).then(r=>r.data),
