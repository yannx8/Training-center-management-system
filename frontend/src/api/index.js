...
export const authApi = {
    ...
    changePassword: b => api.put('/auth/change-password', b).then(r => r.data),
...
export const adminApi = {
    ...
    updateSemester: (id, b) => api.put(`/admin/semesters/${id}`, b).then(r => r.data),
    deleteSemester: id => api.delete(`/admin/semesters/${id}`).then(r => r.data),
    ...
    getAllTrainers: () => api.get('/admin/trainers').then(r => r.data),
    ...
    getAcademicLevels: (p) => api.get('/admin/academic-levels', { params: p }).then(r => r.data),
    createAcademicLevel: (b) => api.post('/admin/academic-levels', b).then(r => r.data),
    updateAcademicLevel: (id, b) => api.put(`/admin/academic-levels/${id}`, b).then(r => r.data),
    deleteAcademicLevel: id => api.delete(`/admin/academic-levels/${id}`).then(r => r.data),
...
export const trainerApi = {
    ...
    getStudentsForGrading: () => api.get('/trainer/students-for-grading').then(r => r.data),
    generateCertTimetable: b => api.post('/trainer/cert-timetable/generate', b).then(r => r.data),
    getCertStudentStatus: p => api.get('/trainer/cert-timetable/student-status', { params: p }).then(r => r.data),
...
export const secretaryApi = {
    ...
    getStudents: p => api.get('/secretary/students', { params: p }).then(r => r.data),
